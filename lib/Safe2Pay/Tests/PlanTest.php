...
use Safe2Pay\Models\Plan;
use Safe2Pay\Models\PlanFrequence;
use Safe2Pay\Api\PlanRequest;

include_once(__DIR__.'/../Models/Merchant/Plan.php');
include_once(__DIR__.'/../Models/Merchant/PlanFrequence.php');
include_once(__DIR__.'/../Request/PlanRequest.php');
